...
# Define the default dataset directory and logs directory
...
create_directory_if_not_exists(_LOGS_DIR)
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(os.path.join(_LOGS_DIR, 'data_loading.log')),
